...
* Installation
  Install directly from the Git repository with ~package-vc~:
...
(unless (package-installed-p 'chezmoi-mode)
  (package-vc-install "https://github.com/chuxubank/chezmoi-mode"))
(unless (package-installed-p 'chezmoi-transient)
  (package-vc-install
   '(chezmoi-transient
     :url "https://github.com/chuxubank/chezmoi-mode"
